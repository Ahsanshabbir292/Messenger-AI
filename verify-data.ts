...
try {
  if (fs.existsSync(configPath)) {
    ...
    console.log("[Diagnostic] firebase-applet-config.json not found. Using environment variables.");
    firebaseConfig = {
  ...
  console.log("[Diagnostic] Error loading config, using env defaults:", e.message);
}
firebaseConfig.firestoreDatabaseId = firebaseConfig.firestoreDatabaseId || process.env.FIREBASE_DATABASE_ID || process.env.FIREBASE_FIRESTORE_DATABASE_ID || "ai-studio-29c3908b-22bc-437d-90bc-108c053233ac";
