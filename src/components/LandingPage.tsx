      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-2 group cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <div className={`p-2 rounded-xl transition-all duration-300 shadow-md ${scrolled ? 'bg-blue-600 text-white' : 'bg-white text-blue-600'}`}>
              <Facebook className="w-5 h-5" />
            </div>
            <span className="text-xl font-black tracking-tight text-slate-900 font-sans">
              MyAim<span className="text-blue-600">MyDream</span>
            </span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            <button 
              ...
              className="text-sm font-semibold text-slate-600 hover:text-blue-600 transition-colors uppercase tracking-wider cursor-pointer"
            >
              Features
            </button>
            <button 
          ...
          <div className="hidden md:flex items-center gap-4">
            <button 
              onClick={onSignIn}
              className="text-sm font-bold text-slate-700 hover:text-blue-600 transition-colors cursor-pointer px-4 py-2"
            >
              Log in
            </button>
            <button 
              onClick={onSignUp}
              className="bg-blue-600 text-white px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest shadow-lg shadow-blue-500/20 hover:bg-blue-700 transition-all active:scale-95 cursor-pointer"
            >
              Start free trial
            </button>
          </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-col gap-4">
                ...
                <button 
                  ...
                  className="w-full bg-blue-600 text-white py-3.5 rounded-xl font-black text-sm uppercase tracking-widest shadow-xl shadow-blue-500/10 text-center"
                >
                  Start Free Trial
                </button>
              </div>
...
const MacbookLiveSimulator = ({ onAuthClick }: { onAuthClick: () => void }) => {
  ...
  const handlePostChatMessage = () => {
    ...
    setTimeout(() => {
      const responsePool = [
        "JazakAllah for your response! MyAimMyDream API is listening live. We can schedule a custom compliance message block for you.",
    ...
    <div className="relative w-full max-w-5xl mx-auto rounded-3xl bg-slate-900 shadow-2xl p-4 md:p-6 border-4 border-slate-700/80">
      ...
      <div className="flex items-center justify-between border-b border-slate-800 pb-4 mb-4">
        ...
        <div className="bg-slate-800/80 text-slate-400 text-[10px] md:text-xs px-6 py-1.5 rounded-full font-mono text-center w-1/2 md:w-2/3 truncate flex items-center justify-center gap-1">
          <span className="text-emerald-500">●</span> myaimmydream.com/app/live-workspace
        </div>

        <div className="flex items-center gap-2">
          <span className="text-[10px] text-white/50 bg-blue-600/30 font-black px-2 py-0.5 rounded uppercase tracking-wider hidden sm:inline-block">LIVE SIMULATION</span>
        </div>
      </div>
      ...
      <div className="bg-slate-950 rounded-2xl overflow-hidden shadow-inner text-slate-100 flex flex-col md:flex-row min-h-[460px] max-h-[580px] font-sans">
        ...
        <div className="w-full md:w-56 bg-slate-900 border-r border-slate-800/50 flex flex-col p-4 justify-between gap-4">
          <div className="space-y-4">
            ...
            <div className="px-2 py-1.5 flex items-center gap-2">
              ...
              <div>
                ...
                <span className="text-[8px] text-blue-400 font-bold tracking-widest">AIM & DREAM WORKSPACE</span>
              </div>
            </div>
            ...
            <div className="space-y-1">
              <button 
                ...
                className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-bold leading-none tracking-tight transition-all cursor-pointer ${activeTab === 'broadcast' ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/10' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}`}
              >
              ...
              <button 
                ...
                className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-bold leading-none tracking-tight transition-all cursor-pointer ${activeTab === 'chat' ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/10' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}`}
              >
              ...
              <button 
                ...
                className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-bold leading-none tracking-tight transition-all cursor-pointer ${activeTab === 'pages' ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/10' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}`}
              >
              ...
              <button 
                ...
                className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-bold leading-none tracking-tight transition-all cursor-pointer ${activeTab === 'audience' ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/10' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}`}
              >
              ...
              <button 
                ...
                className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-bold leading-none tracking-tight transition-all cursor-pointer ${activeTab === 'analytics' ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/10' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}`}
              >
          ...
          <div className="bg-slate-950 p-2.5 rounded-xl border border-slate-800 flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-full bg-blue-600/20 text-blue-400 font-black text-xs flex items-center justify-center">
              MY
            </div>
            <div className="truncate">
              <p className="text-[10px] font-black leading-tight text-white">Business Demo</p>
              <span className="text-[8px] text-slate-500 block leading-tight">MyAimMyDream Active</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 bg-slate-950 p-5 md:p-6 overflow-y-auto min-h-[300px]">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-slate-900 border border-slate-800 p-3.5 rounded-2xl text-center">
                  ...
                  <p className="text-xl md:text-2xl font-black text-blue-500 mt-1">{sendingStats.sent}</p>
                </div>
                <div className="bg-slate-900 border border-slate-800 p-3.5 rounded-2xl text-center">
              ...
              <div className="bg-slate-900 border border-slate-800/80 p-4 rounded-2xl">
                ...
                <div className="w-full bg-slate-950 h-3 rounded-full overflow-hidden border border-slate-800">
                  <div className="bg-blue-600 h-full rounded-full transition-all duration-1000" style={{ width: '4%' }} />
                </div>
              </div>
                ...
                <div className="space-y-2 max-h-[180px] overflow-y-auto">
                  {logItems.map((item, idx) => (
                    <div key={item.id} className="bg-slate-900/60 p-3 rounded-xl border border-slate-800/50 flex items-center justify-between gap-3 text-xs">
                      ...
                      <span className={`text-[9px] font-black px-2.5 py-0.5 rounded leading-none uppercase ${item.status === 'delivered' ? 'bg-emerald-500/10 text-emerald-400' : item.status === 'sending' ? 'bg-blue-500/10 text-blue-400 animate-pulse' : 'bg-slate-800 text-slate-400'}`}>
                        {item.status}
                      </span>
                    </div>
                  ))}
            ...
            <div className="space-y-4 flex flex-col h-full justify-between">
                ...
                <div className="space-y-3 max-h-[220px] overflow-y-auto p-1">
                  {chatLog.map(msg => (
                    <div key={msg.id} className={`flex max-w-[85%] gap-2.5 ${msg.sender === 'user' ? 'ml-auto flex-row-reverse' : 'mr-auto'}`}>
                      <div className={`w-7 h-7 rounded-full flex items-center justify-center shrink-0 ${msg.sender === 'user' ? 'bg-slate-800 text-slate-300' : 'bg-blue-600 text-white'}`}>
                        {msg.sender === 'user' ? <User className="w-3.5 h-3.5" /> : <Bot className="w-3.5 h-3.5" />}
                      </div>
                      <div className={`p-3.5 rounded-2xl text-xs leading-relaxed whitespace-pre-wrap ${msg.sender === 'user' ? 'bg-slate-900 text-slate-200 rounded-tr-none' : 'bg-blue-900/20 text-slate-200 border border-blue-500/20 rounded-tl-none'}`}>
                        {msg.text}
                      </div>
                    </div>
                  ))}
              ...
              <div className="pt-3 border-t border-slate-800/80 flex items-center gap-2.5">
                <input 
                  ...
                  className="flex-1 bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-xs text-white focus:outline-none focus:border-blue-600 uppercase tracking-wider font-bold"
                />
                <button 
                  onClick={handlePostChatMessage}
                  className="bg-blue-600 text-white w-10 h-10 rounded-xl flex items-center justify-center hover:bg-blue-700 transition-colors cursor-pointer shrink-0"
                >
          ...
          {activeTab === 'pages' && (
            <div className="space-y-6">
                ...
                {connectedPages.map(page => (
                  <div key={page.id} className="bg-slate-900 border border-slate-800 p-4 rounded-2xl flex items-center justify-between gap-4">
                    ...
                    <button 
                      ...
                      className={`px-3.5 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest cursor-pointer transition-all ${page.connected ? 'bg-red-500/10 text-red-400 border border-red-500/20 hover:bg-red-500/20' : 'bg-blue-600 text-white hover:bg-blue-700 shadow shadow-blue-500/10'}`}
                    >
              ...
              >
                <PlusCircle className="w-4 h-4 text-blue-500" /> OAuth Link More Pages
              </button>
            </div>
          )}
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between gap-4 flex-wrap">
                ...
                <input 
                  ...
                  className="bg-slate-900 border border-slate-800 px-3 py-1.5 rounded-xl text-xs text-white focus:outline-none focus:border-blue-600 w-full sm:w-48 font-bold uppercase tracking-wider"
                />
              </div>
                ...
                {filteredAudience.map((subscriber, idx) => (
                  <div key={idx} className="bg-slate-900/65 border border-slate-800 p-3 rounded-xl flex items-center justify-between gap-4 text-xs">
                    <div className="flex items-center gap-3 truncate">
                      <div className="w-8 h-8 rounded-full bg-blue-600/15 text-blue-400 font-bold flex items-center justify-center text-[11px] shrink-0">
                    ...
                    <span className="text-[9px] bg-blue-500/15 border border-blue-500/10 text-blue-400 px-2 py-0.5 rounded uppercase font-black shrink-0">
                      {subscriber.tag}
                    </span>
                  </div>
                ))}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3.5">
                ...
                <div className="bg-slate-900 border border-slate-800 p-3 rounded-xl">
                  ...
                  <p className="text-lg font-black text-blue-400 mt-1">&lt; 0.28s</p>
                </div>
              </div>
    ...
    <section className="py-24 bg-white border-y border-slate-50 relative">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 px-3 py-1 bg-blue-50 rounded-full">TRANSFORMING RETAIL OUTCOME</span>
          ...
          <p className="mt-4 text-slate-500 font-medium text-sm md:text-base">
            See the dramatic difference between manual messaging and MyAimMyDream's automated broadcast system. Real results from real businesses.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <div>
              <div className="flex items-center justify-between mb-8 pb-4 border-b border-slate-200/50">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-lg font-black text-slate-800 leading-none">Before MyAimMyDream</h3>
                </div>
          ...
          {/* With Column */}
          <div className="p-8 rounded-[2.5rem] bg-blue-600 text-white shadow-xl shadow-blue-500/10 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-8 pb-4 border-b border-blue-500/35">
                <div className="flex items-center gap-2">
                  <ShieldCheck className="w-5 h-5 text-emerald-400 fill-emerald-500/20" />
                  <h3 className="text-lg font-black text-white leading-none">With MyAimMyDream</h3>
                </div>
              ...
              <div className="space-y-5">
                <div className="flex justify-between items-center bg-blue-700/50 p-4 rounded-xl border border-blue-500/30">
                  <span className="text-blue-100 text-xs font-bold uppercase tracking-wider">Automated broadcast delivery</span>
                  <span className="text-white font-black text-sm select-none">&lt; 5 min</span>
                </div>
                <div className="flex justify-between items-center bg-blue-700/50 p-4 rounded-xl border border-blue-500/30">
                  <span className="text-blue-100 text-xs font-bold uppercase tracking-wider">High engagement rates</span>
                  <span className="text-emerald-400 font-black text-sm select-none">35%+</span>
                </div>
                <div className="flex justify-between items-center bg-blue-700/50 p-4 rounded-xl border border-blue-500/30">
                  <span className="text-blue-100 text-xs font-bold uppercase tracking-wider">Massive audience reach</span>
                  <span className="text-white font-black text-sm select-none">10,000+/hr</span>
                </div>
                <div className="flex justify-between items-center bg-blue-700/50 p-4 rounded-xl border border-blue-500/30">
                  <span className="text-blue-100 text-xs font-bold uppercase tracking-wider">Real-time analytics</span>
                  <span className="text-emerald-400 font-black text-sm select-none">Live tracking</span>
                </div>
              </div>
            </div>

            <p className="text-blue-200 text-[10px] uppercase font-bold tracking-widest text-center mt-6">Secure, fully policy-compliant broadcasting loops</p>
          </div>
        </div>
          ...
          <div className="relative z-10 flex flex-col xl:flex-row gap-10 items-center">
            <div className="w-full xl:w-2/3 h-72">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <span className="text-[10px] text-blue-400 font-black uppercase tracking-widest block">Live Performance</span>
                ...
                <div className="flex items-center gap-4 text-[9px] uppercase font-bold tracking-wider">
                  ...
                  <span className="flex items-center gap-1.5 text-blue-400">
                    <span className="w-2.5 h-1.5 bg-blue-500 rounded-full animate-pulse" /> With MyAimMyDream (+340% yr)
                  </span>
                </div>
              </div>
              ...
              <ResponsiveContainer width="100%" height="80%">
                <LineChart data={data}>
                  ...
                  <Line type="monotone" dataKey="Without" name="Without MyAimMyDream" stroke="#475569" strokeWidth={2} activeDot={{ r: 6 }} />
                  <Line type="monotone" dataKey="With" name="With MyAimMyDream" stroke="#3b82f6" strokeWidth={4} activeDot={{ r: 8 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="w-full xl:w-1/3 grid grid-cols-2 gap-4">
              ...
              <div className="bg-slate-850 p-5 rounded-2xl border border-slate-800">
                <span className="text-[9px] font-black uppercase tracking-widest text-slate-400 text-blue-400">Messages Sent</span>
...
const StepsGuide = () => {
  return (
    <section id="how-it-works" className="py-24 bg-slate-50/50 relative">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 bg-blue-50 px-3 py-1 rounded-full">HOW TO START</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="p-8 rounded-[2.5rem] bg-white border border-slate-200/60 shadow-sm relative overflow-hidden group">
            <span className="text-4xl font-black text-slate-100 group-hover:text-blue-50/70 transition-colors absolute right-8 top-8 select-none">01</span>
            <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 mb-8 font-black">
              1
            </div>
          ...
          <div className="p-8 rounded-[2.5rem] bg-white border border-slate-200/60 shadow-sm relative overflow-hidden group">
            <span className="text-4xl font-black text-slate-100 group-hover:text-blue-50/70 transition-colors absolute right-8 top-8 select-none">02</span>
            <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 mb-8 font-black">
              2
            </div>
          ...
          <div className="p-8 rounded-[2.5rem] bg-white border border-slate-200/60 shadow-sm relative overflow-hidden group">
            <span className="text-4xl font-black text-slate-100 group-hover:text-blue-50/70 transition-colors absolute right-8 top-8 select-none">03</span>
            <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 mb-8 font-black">
              3
            </div>
...
const FeaturesGrid = () => {
  const list = [
    ...
    {
      icon: <Shield className="w-5 h-5 text-emerald-505" />,
      title: "100% Meta compliant rules",
      desc: "Breathe easy knowing MyAimMyDream restricts messages to compliant tags. Automated timers guarantee safe rate protection."
    },
    {
    ...
    <section id="features" className="py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 px-3 py-1 bg-blue-50 rounded-full">CORE FEATURES MANUAL</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {list.map((item, idx) => (
            <div key={idx} className="bg-slate-50/50 p-8 rounded-[2.5rem] border border-slate-200/50 hover:bg-white hover:border-slate-300 hover:shadow-xl hover:shadow-blue-500/5 transition-all duration-300">
    ...
    <section className="py-20 bg-slate-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        <p className="text-xl md:text-2xl font-black leading-relaxed tracking-tight italic text-slate-100">
          "MyAimMyDream transformed our customer communication. We've seen a 40% increase in engagement since switching to their broadcast tool."
        </p>
        
        <div className="mt-8 flex items-center justify-center gap-3">
          <div className="w-11 h-11 rounded-full bg-blue-600/30 text-blue-400 border border-blue-500/20 font-black flex items-center justify-center">
            SM
          </div>
  ...
  const plans = [
    {
      ...
      features: [
        ...
        "Unlimited Audience Storage",
        "High-Speed Bulk Messaging",
        "Advanced Filters & Segmentation",
        "Personalized Messages",
        "Schedule Broadcasts Anytime",
        "Live Delivery & Tracking",
        "Inbox Available as Add-on"
      ],
      recommended: false
    },
    {
      name: "Starter",
      purpose: "Essential tools for small teams",
      basePrice: 25,
      credits: "300,000",
      perMsg: "$0.000083",
      inbox: "Inbox Add-on Required",
    ...
    {
      name: "Enterprise",
      purpose: "Maximum volume & support",
      basePrice: 249,
      credits: "4,500,000",
      perMsg: "$0.000055",
      inbox: "Premium Inbox Included",
    ...
    <section id="pricing" className="py-24 bg-slate-50/70 relative">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 bg-blue-50 px-3 py-1 rounded-full">PLAN OPTIONS</span>
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 mt-4 tracking-tight">
        ...
        <div className="flex items-center justify-center gap-3 mb-16">
          <button 
            ...
            className={`px-4 py-2 rounded-xl text-xs font-bold leading-none uppercase tracking-wide transition-all cursor-pointer ${cycle === 'monthly' ? 'bg-blue-600 text-white shadow shadow-blue-500/10' : 'bg-white text-slate-500 hover:text-slate-800'}`}
          >
            Monthly
          </button>
          ...
          <button 
            ...
            className={`px-4 py-2 rounded-xl text-xs font-bold leading-none uppercase tracking-wide transition-all cursor-pointer flex items-center gap-1.5 ${cycle === 'quarterly' ? 'bg-blue-600 text-white shadow shadow-blue-500/10' : 'bg-white text-slate-500 hover:text-slate-800'}`}
          >
          ...
          <button 
            ...
            className={`px-4 py-2 rounded-xl text-xs font-bold leading-none uppercase tracking-wide transition-all cursor-pointer flex items-center gap-1.5 ${cycle === 'yearly' ? 'bg-blue-600 text-white shadow shadow-blue-500/10' : 'bg-white text-slate-500 hover:text-slate-800'}`}
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-6 items-stretch">
          {plans.map((plan, idx) => (
            <div 
              key={idx} 
              className={`p-6 rounded-[2.5rem] bg-white border flex flex-col justify-between transition-all duration-300 relative ${plan.recommended ? 'border-blue-500 shadow-xl shadow-blue-500/5 ring-2 ring-blue-500/20' : 'border-slate-200 hover:border-slate-350 shadow-sm'}`}
            >
              {plan.recommended && (
              ...
              <div className="mt-8">
                <button 
                  onClick={onSignUp}
                  className={`w-full py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest cursor-pointer transition-colors ${plan.recommended ? 'bg-blue-600 text-white hover:bg-blue-700 shadow-md shadow-blue-500/25' : 'bg-slate-100 text-slate-800 hover:bg-slate-200'}`}
                >
                  Get Started
                </button>
              </div>
...
const FAQSection = () => {
  ...
  const faqs = [
    {
      q: "What is MyAimMyDream and how does it help Facebook Page owners?",
      a: "MyAimMyDream is an enterprise-qualified broadcasting and CRM tool for Facebook Messenger. It enables brand and page owners to send automated bulk campaigns to subscribers with full compliance, retrieve real-time inventory metrics, and qualify leads without trigger manual fatigue index boundaries."
    },
    {
      q: "Is MyAimMyDream free to try?",
    ...
    {
      q: "Will using MyAimMyDream put my Facebook Page at risk?",
    ...
    {
      q: "Do I need technical skills to use MyAimMyDream?",
    ...
    <section id="faq" className="py-24 bg-white border-t border-slate-50 relative">
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16">
          <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 bg-blue-50 px-3 py-1 rounded-full">SUPPORT DESK</span>
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 mt-4 tracking-tight">
            Frequently Asked Questions
          </h2>
          <p className="mt-4 text-slate-500 font-medium text-sm md:text-base leading-relaxed">
            Everything you need to know about MyAimMyDream
          </p>
        </div>
          ...
          {faqs.map((faq, idx) => (
            ...
            >
              ...
              >
                ...
                <HelpCircle className={`w-5 h-5 text-blue-550 shrink-0 transition-transform ${activeFAQ === idx ? 'rotate-180 text-blue-600' : 'text-slate-400'}`} />
              </button>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-2 space-y-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-black text-white tracking-tight uppercase">MyAimMyDream</span>
            </div>
            <p className="max-w-md text-slate-405 text-sm leading-relaxed">
              MyAimMyDream is the leading Facebook Messenger broadcast tool. Send bulk messages to your Page audience with full Meta policy compliance.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-xs font-bold uppercase tracking-wider">
              <li><button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-blue-400 transition-colors cursor-pointer block text-left">Features</button></li>
              <li><button onClick={onSignIn} className="hover:text-blue-400 transition-colors cursor-pointer block text-left">Login</button></li>
              <li><button onClick={onSignUp} className="hover:text-blue-400 transition-colors cursor-pointer block text-left">Pricing PLANS</button></li>
              <li><button onClick={onSupportClick} className="hover:text-blue-400 transition-colors cursor-pointer block text-left">Support FAQ</button></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-xs font-bold uppercase tracking-wider">
              <li><button onClick={onPrivacyClick} className="hover:text-blue-400 transition-colors cursor-pointer block text-left">Privacy Policy</button></li>
              <li><button onClick={onTermsClick} className="hover:text-blue-400 transition-colors cursor-pointer block text-left">Terms & Conditions</button></li>
        ...
        <div className="pt-10 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-6">
          <span className="text-[10px] font-black uppercase tracking-widest opacity-35">
            &copy; {new Date().getFullYear()} MyAimMyDream Broadcast Automation. All rights reserved.
          </span>
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-blue-600 selection:text-white">
      ...
      <main>
        ...
        <section className="relative pt-32 pb-24 lg:pt-44 lg:pb-32 overflow-hidden bg-[radial-gradient(circle_at_top_right,#EFF6FF_0%,#FFFFFF_45%)]">
          <div className="absolute top-20 right-0 w-[600px] h-[600px] bg-blue-50 rounded-full blur-[120px] opacity-60 -mr-96" />
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-blue-100 rounded-full blur-[100px] opacity-30 -ml-40" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
              ...
              <div className="lg:col-span-5 space-y-8 text-left">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 border border-blue-100 rounded-full">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-wider text-blue-600">100% Meta Policy Compliant</span>
                </div>

                <div className="space-y-4">
                  <h1 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight leading-none">
                    Facebook Messenger <br />
                    <span className="text-blue-600">Broadcast Tool</span>
                  </h1>
                ...
                <div className="flex flex-wrap items-center gap-4">
                  <button 
                    onClick={onSignUp}
                    className="bg-blue-600 hover:bg-blue-700 text-white font-black text-xs uppercase tracking-widest px-8 py-4 rounded-2xl transition-all shadow-xl shadow-blue-500/25 flex items-center gap-2 cursor-pointer active:scale-95"
                  >
                    Start Free Trial <ArrowRight className="w-4 h-4" />
                  </button>
                  <button 
                    onClick={onSignIn}
                    className="bg-white hover:bg-slate-50 text-slate-705 font-black text-xs uppercase tracking-widest px-8 py-4 rounded-2xl transition-all border border-slate-200/80 cursor-pointer active:scale-95"
                  >
                    Sign In
                  </button>
                </div>
                ...
                <div className="flex items-center gap-4 pt-4 border-t border-slate-150">
                  ...
                  <div className="text-xs">
                    <span className="font-sans font-black text-slate-800">4.9/5</span> &bull; <span className="text-slate-500 font-medium text-[11px]">10,000+ businesses trust MyAimMyDream</span>
                  </div>
                </div>
              </div>
        ...
        <section className="py-24 px-6 bg-white relative">
          <div className="max-w-5xl mx-auto bg-blue-600 rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden shadow-2xl">
            <div className="absolute inset-0 bg-gradient-to-tr from-blue-800 to-transparent opacity-90" />
            ...
            <div className="relative z-10 flex flex-col items-center gap-6">
              ...
              <p className="text-blue-100 text-sm max-w-xl font-bold uppercase tracking-widest block">
                Join thousands of businesses using MyAimMyDream for Facebook Messenger marketing. Start your free trial today.
              </p>

              <div className="pt-4 flex flex-col gap-4">
                <button 
                  onClick={onSignUp}
                  className="bg-white hover:bg-slate-50 text-blue-600 font-black text-xs uppercase tracking-widest px-10 py-5 rounded-2xl transition-all shadow-xl active:scale-95 cursor-pointer block"
                >
                  Start Free Trial
                </button>
                <div className="flex items-center justify-center gap-2 text-[10px] uppercase font-bold tracking-wider text-blue-105">
